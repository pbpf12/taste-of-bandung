...
class Review(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='main_reviews')
...
class Bookmark(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='last_activities_bookmarks')
    restaurant = models.ForeignKey(Restaurant, on_delete=models.SET_NULL, null=True, blank=True)
    dish = models.ForeignKey(Dish, on_delete=models.SET_NULL, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class History(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='last_activities_histories')
    dish = models.ForeignKey(Dish, on_delete=models.SET_NULL, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
